        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <a href="mailto:support@infoedurushacademy.com?subject=Inquiry%20about%20EduRush%20Academy" className="flex items-center gap-3 text-sm text-primary-foreground/50 hover:text-accent transition-colors"><Mail className="w-4 h-4 text-accent flex-shrink-0" />support@infoedurushacademy.com</a>
