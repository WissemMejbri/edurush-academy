...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  tutor_assigned: { label: "Tutor Assigned", className: "bg-blue-500/10 text-blue-600 border-blue-200" },
  ...
  declined: { label: "Rejected", className: "bg-destructive/10 text-destructive border-destructive/20" },
