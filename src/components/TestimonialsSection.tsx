...
const testimonials = [
  {
    ...
    country: "Tunisia",
    text: "EduRush transformed my approach to studying. I went from a 5 to a 7 in IB Mathematics in just one semester. The tutors truly care about your success.",
    rating: 5,
  ...
  },
  {
    ...
    country: "UK",
    text: "As a parent, I appreciate the detailed progress reports and the genuine dedication of the tutors. My son's grades improved remarkably in just months.",
    rating: 5,
  ...
  },
  {
    ...
    country: "Qatar",
    text: "The personalized study plans and exam preparation sessions were exactly what I needed. I secured my A* grades and got accepted to my dream university!",
    rating: 5,
      ...
      <div className="container mx-auto relative">
        ...
        >
          ...
          <motion.p variants={fadeUp} custom={2} className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Hear from students and parents who've experienced the EduRush difference.
          </motion.p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map(({ name, role, country, text, rating, image }, i) => (
            <motion.div
              ...
              variants={fadeUp}
              custom={i}
              className="relative bg-card rounded-2xl border border-border p-8 premium-shadow-sm hover:premium-shadow transition-all duration-300"
            >
